...
if(isset($_POST['submit'])){
    ...
    $folder = "studentprofile/".$filename;
 ...
 //   $image=$_POST['image'];
    $query="INSERT INTO student(name, email,password,image) VALUES ('$name', '$email', '$password','$folder')";
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="post" action="signup-user.php" enctype="multipart/form-data">
                            ...
                            <p class="text-center mb-0">Already have an Account? <a href="signin-user.php">Sign In</a></p>
                        </form>
                    </div>
                </div>
            </div>
